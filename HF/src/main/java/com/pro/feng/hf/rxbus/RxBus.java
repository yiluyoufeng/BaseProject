...
public class RxBus {
    ...
    private Map<Class, List<Disposable>> subscriptionsByEventType = new HashMap<>();//用于取消订阅

    private Map<Object, List<Class>> eventTypesBySubscriber = new HashMap<>();//存放那些类注册了订阅

    private Map<Class, List<SubscriberMethod>> subscriberMethodByEventType = new HashMap<>();//存放订阅类中存放那些订阅方法
