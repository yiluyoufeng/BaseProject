package com.pro.feng.hf.core.http.retrofit;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.pro.feng.hf.core.http.okhttp.HttpCache;
import com.pro.feng.hf.core.http.okhttp.interceptor.AppInterceptor;
import com.pro.feng.hf.core.http.okhttp.interceptor.NetworkInterceptor;
...
//                    .addParam("androidType", "") //安卓机类型:0华为 1小米 2其他 (目前华为推送无法使用所以固定用1)
            ...
            baseUrl = "http://www.weather.com.cn/";//TODO 添加baseUrl
